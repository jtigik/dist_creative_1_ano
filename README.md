...
O cronograma diário substitui o cronograma semanal, mantendo o mesmo conteúdo programático e carga horária total (105 horas), mas distribuído conforme a nova divisão de horas por dia. Cada semana terá 7 horas de aula, distribuídas em 4 dias (2h na segunda, 2h na terça, 2h na quinta e 1h na sexta). O conteúdo foi ajustado para se adequar ao ritmo diário, mantendo a progressão lógica dos módulos **UI/UX com Figma** e **HTML + CSS**, e as atividades integradas.

---

## Cronograma Diário (26/05/2025 a 05/09/2025)

*Observação:* O cronograma considera 15 semanas, com 7 horas semanais distribuídas em 4 dias. Ajustes podem ser feitos para feriados ou eventos escolares. Cada dia reflete uma sessão de aprendizado com atividades teórico-práticas e/ou projetos.
...
| **13** | 18/08/2025 | Segunda     | HTML/CSS  | Projeto prático: início da implementação de layout    | 2h            |
...
Este cronograma diário mantém a estrutura do plano original, adaptando-se à distribuição de 2h (segunda, terça, quinta) e 1h (sexta). Caso precise de mais ajustes ou detalhes, é só informar!
